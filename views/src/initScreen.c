...
void initLoginScreen(UserData* userData) {
    GtkBuilder *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/login.glade");
    ...
    gtk_css_provider_load_from_path(provider_login,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initRegisterScreen(UserData* userData) {
    GtkBuilder *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/register.glade");
    ...
    gtk_css_provider_load_from_path(provider_register,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initShowScreen(UserData* userData) {
    ...
    GtkBuilder *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/show1.glade");
    ...
    gtk_css_provider_load_from_path(provider_show,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initHomeScreen(UserData* userData){
    GtkBuilder *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/home.glade");
    ...
    gtk_css_provider_load_from_path(provider_home,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initShareScreen(UserData* userData) {
    GtkBuilder *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/share_place.glade");
    ...
    gtk_css_provider_load_from_path(provider_share,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initAddFriendScreen(UserData* userData) {
    GtkBuilder  *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/addFriend.glade");
    ...
    gtk_css_provider_load_from_path(provider_addFriend,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
...
void initFriendRequestScreen(UserData* userData){
    GtkBuilder  *builder = gtk_builder_new_from_file("/home/phonghoang/ltm/ProgramingNetwork/views/src/screen/friendRequest.glade");
    ...
    gtk_css_provider_load_from_path(provider_friendRequest,"/home/phonghoang/ltm/ProgramingNetwork/views/src/style/style.css",NULL);
